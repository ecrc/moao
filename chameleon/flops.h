...
#define FLOPS_DCovMat(__m, __n, _l, _type_mat) ( (_type_mat) == 1 ? ((30. + (_l) * 115) * ( (double)(__m) * ((double)(__m) + 1.) / 2.0)) : ( ( _type_mat) == 3 ? ((30. + (_l) * 103) * (double)(__m) * (double)(__n) ) : ((30. + (_l) * 90) * (double)(__m) * (double)(__n) ) ) )
#else
#define FLOPS_DCovMat(__m, __n) ( 2.0 * (double)(__m) * (double)(__n) )
#endif

#ifdef USE_INTERSAMPLE
  #define FLOPS_Intersample(__m, __n) ( (double)(__m) * (double)(__n) * 20)
