...
//============================================================================================
inline __device__ double macdo_x56_gpu(double x, int k)
...
//------------------------------------------------------------------------------------
inline __device__ double asymp_macdo_gpu(double x)
...
//------------------------------------------------------------------------------------
inline __device__ double rodconan_gpu(double r, double L0, int k)
...
inline __device__ double DPHI_gpu(double x, double y, double indexL0)
...
//============================================================================================
inline __device__ double cov_XX_gpu(double du, double dv, double ac, double ad, double bc, double bd, double indexL0)
 /* DOCUMENT
...
inline __device__ double cov_YY_gpu(double du, double dv, double ac, double ad, double bc, double bd, double indexL0)
/* DOCUMENT
...
//------------------------------------------------------------------------------------
inline __device__ double cov_XY_gpu(double du, double dv, double s1, double s2, long indexL0)
{
...
//------------------------------------------------------------------------------------
inline __device__ double cov_YX_gpu(double du, double dv, double s1, double s2, long indexL0)
{
...
//============================================================================================
inline __device__ double compute_element_4(int ipos, int jpos, double *sspSizeL, long *Nssp, double *u, double *v,
...
//------------------------------------------------------------------------------------------
__global__ void matcov_kernel_gpu_4(char uplo, char copy, double* data, int nrows, int ncols, int xoffset, int yoffset, int lda,
  ...
  double *noiseLGSyy, double *noiseLGSxy, int type_mat, int nlgs, double DiamTel,cudaStream_t stream)
{
  ...
  matcov_kernel_gpu_4<<<dimGrid, dimBlock, 0, stream>>>(uplo, copy, data, nrows, ncols, xoffset, yoffset, lda, sspSizeL, 
						Nssp, u, v,
